function student_registration() {
    ...
    const idError = document.getElementById('student_id_error');
    ...
    fetch('/add_students_as_import', {
        ...
        .then(data => {
            ...
            if (data.status === 'success' || data.success === true) {
                succ_msg.classList.remove('d-none');
                succ_msg.innerHTML = data.message || "Students imported successfully!";
        ...
        .finally(() => {
            ...
            buttonText.textContent = 'Import Students';
        });
}